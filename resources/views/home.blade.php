...
<link rel="stylesheet" href="{{ asset('css/site.css') }}?v=mci-pwa-footer-v1">@verbatim
...
<footer><div class="footer-brand"><img class="footer-logo" src="{{ asset('images/mci-logo.webp') }}" alt="MCI logo"><div><b>Micro Computer Institute</b><p>Skills for today. Confidence for tomorrow.</p></div></div><div class="footer-links"><a href="#courses">Courses</a><a href="{{ route('admission.create') }}">Online Admission</a><a href="#jobs">Job Search</a><a href="{{ route('certificates.verify') }}">Verify Certificate</a><a href="{{ route('student.login') }}">Student Login</a><a href="#enquiry">Enquiry</a><a href="{{ route('admin.login') }}">Admin</a></div><div class="footer-app"><span>MCI ON YOUR PHONE</span><button id="installMciApp" type="button">Install MCI App ↓</button><small id="installMciHelp">Fast access from your home screen</small></div><small>© {{ date('Y') }} Micro Computer Institute.</small></footer>
...
@endphp
<script>window.MCI_COURSES = @json($mciCourses);</script><script src="{{ asset('js/navigation.js') }}"></script><script src="{{ asset('js/site.js') }}"></script><script src="{{ asset('js/install-app.js') }}?v=1"></script></body></html>
